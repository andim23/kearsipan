...
<html> 
    ...
    <div class="Section2">
        ...
        <br><br>
        <span class="f2"><center>BUKU AGENDA SURAT MASUK<br>Bulan: ...</center></span>
        <br><table class="word-table" style="margin-bottom: 10px">
            <tr style="background-color: #cec9c9">
                <th style="text-align: center" width="10">No</th>
		<th style="text-align: center" width="30">Tanggal Terima</th>
		<th style="text-align: center" width="30">Tanggal Surat</th>
		<th style="text-align: center" width="40">Nomor Surat</th>
		<th style="text-align: center" width="40">Pengirim</th>
		<th style="text-align: center" width="50">Perihal</th>
		<th style="text-align: center" width="30">Diteruskan Kepada</th>
		<th style="text-align: center" width="30">Kode Arsip (Klasifikasi)</th>
		
            </tr><?php
            foreach ($agenda_surat_masuk_data as $agenda_surat_masuk)
            {
                ?>
                <tr>
		      <td><?php echo ++$start ?></td>
		      <td><?php echo shortdate_indo($agenda_surat_masuk->tgl_terima) ?></td>
		      <td><?php echo shortdate_indo($agenda_surat_masuk->tgl_surat) ?></td>
		      <td><?php echo $agenda_surat_masuk->no_surat ?></td>
		      <td><?php echo $agenda_surat_masuk->pengirim ?></td>
		      <td><?php echo $agenda_surat_masuk->perihal ?></td>
		      <td><?php echo $agenda_surat_masuk->diteruskan_kpd ?></td>
		      <td><?php echo $agenda_surat_masuk->kode_arsip ?></td>	
                </tr>
                <?php
            }
            ?>
